...
public interface WxAuthService{
     ...
     * @return 微信客户端链接
     */
    String wxPpOAuth2CodeAuthorizationUrl(String redirectUrl, String scope, String state, WxConfig wxConfig);
     ...
     * @return 微信网页链接
     */
    String wxOpOAuth2CodeAuthorizationUrl(String redirectUrl, String state,WxConfig wxConfig);
     ...
     * @throws Exception
     */
    WxOAuth2Info wxOpOAuth2AccessToken(String code,WxConfig wxConfig) throws Exception;
     ...
     * @throws Exception
     */
    WxOAuth2Info wxPpOAuth2AccessToken(String code,WxConfig wxConfig) throws Exception;
     ...
     * @throws Exception
     */
    WxOAuth2Info wxSpOAuth2AccessToken(String code,WxConfig wxConfig) throws Exception;
     ...
     * @throws Exception
     */
    WxOAuth2Info wxPpOAuth2ScanAccessToken(WxConfig wxConfig) throws Exception;
     ...
     * @throws Exception
     */
    WxScanSign wxPpOAuth2ScanSign(String url, String accessToken,WxConfig wxConfig) throws Exception;
