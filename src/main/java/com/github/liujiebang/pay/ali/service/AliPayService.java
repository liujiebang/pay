...
public interface AliPayService extends AliService {
     ...
     * @throws PayException
     */
    boolean aliPayReturn(String orderId, double payAmount) throws PayException;
     ...
     * @throws PayException
     */
    boolean aliPayReturnQuery(String orderId) throws PayException;
     ...
     * @throws PayException
     */
    boolean aliPayTransfer(String aliPayAccount, double payAmount) throws PayException;
     ...
     * @throws PayException
     */
    String aliPayQuery(String orderId) throws PayException;
     ...
     * @throws PayException
     */
    boolean aliPayTransQeury(String orderId) throws PayException;
     ...
     * @throws PayException
     */
    AlipayFundAuthOrderAppFreezeResponse aliPayAuthFreeze(String outOrderNo, String requestNo, double payAmount, String orderTitle, String extraParam) throws PayException;
     ...
     * @throws PayException
     */
    boolean aliPayTradePay(String aliUserId, String outOrderNo, String authNo, String storeId, double payAmount) throws PayException;
     ...
     * @throws PayException
     */
    boolean aliPayAuthUnFreeze(String outOrderNo, String authNo, double payAmount, String remark) throws PayException;
     ...
     * @throws PayException
     */
    AlipayFundAuthOperationDetailQueryResponse aliPayAuthOperationQuery(String outOrderNo, String requestNo) throws PayException;
}
