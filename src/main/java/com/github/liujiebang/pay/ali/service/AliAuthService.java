...
public interface AliAuthService{
     ...
     * @return 授权重定向链接
     */
    String publicAppAuthorize(String redirectUrl, String scope, String state,AliPayConfig aliPayConfig);
     ...
     * @return 返回授权令牌，用户ID等
     */
    AlipaySystemOauthTokenResponse systemOauthToken(String authCode, String refreshToken,AliPayConfig aliPayConfig);
     ...
     * @return 返回支付宝用户基本信息
     */
    AlipayUserInfoShareResponse getUserInfoShare(String accessToken,AliPayConfig aliPayConfig);
}
